...
func init() {
	...
	rootCmd.PersistentFlags().String("logto-client-id", utils.DefaultLogtoClientID, "Logto application client ID (optional)")
	...
	viper.BindPFlag("logto_client_id", rootCmd.PersistentFlags().Lookup("logto-client-id"))
